...
const menuItems = [
    { icon: <img src="./src/assets/phonhos-logo.png" alt="" />, text: "เว็บไซด์โรงพยาบาลพล", link: "https://www.phonhospital.go.th/" },
    { icon: <img src="./src/assets/public-health.png" alt="" />, text: "เว็บไซด์กระทรวงสาธารณสุข", link: "https://www.moph.go.th/" },
    { icon: <img src="./src/assets/public-health.png" alt="" />, text: "เว็บไซด์ สสจ. ขอนแก่น", link: "https://www.kkpho.go.th/index.php" },
    { icon: <img src="./src/assets/kphlogo.png" alt="" />, text: "เว็บไซด์สหกรณ์ออมทรัพย์สาธารณสุขจังหวัดขอนแก่น", link: "https://kphcoop.com/" },
    ...
    { icon: <img src="./src/assets/hosxp-logo.png" alt="" />, text: "แบบฟอร์มขอใช้ HOSxp", link: "https://docs.google.com/forms/d/e/1FAIpQLSeghEcR-KjNw30pL676cvjJwHNn5D1hg-3zS2a2xfmkmBusLQ/viewform" },
    { icon: <img src="./src/assets/hosxp-logo.png" alt="" />, text: "แบบฟอร์มขอข้อมูล HOSxp", link: "https://docs.google.com/forms/d/e/1FAIpQLSeghEcR-KjNw30pL676cvjJwHNn5D1hg-3zS2a2xfmkmBusLQ/viewform" },
    ...
    { icon: <img src="./src/assets/spsorchor.png" alt="" />, text: "เว็บ New authentication", link: "https://authenservice.nhso.go.th/authencode/#/login" },
